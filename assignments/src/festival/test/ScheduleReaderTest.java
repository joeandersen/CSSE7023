...
public class ScheduleReaderTest {
	...
	/**
	 * Test that reading a timetable without a number of sessions throws a
	 * FormatException.
	 **/
	@Test(expected = FormatException.class)
	public void testIncorrectlyFormattedNumberOfSessionsb()
			throws FormatException, IOException {
		ScheduleReader.read("read_09_incorrectlyFormatted.txt");
	}
	 ...
	 **/
	@Test(expected = FormatException.class)
	public void testIncorrectlyFormattedVenueNames()
			throws FormatException, IOException {
		ScheduleReader.read("read_10_incorrectlyFormatted.txt");
	}
